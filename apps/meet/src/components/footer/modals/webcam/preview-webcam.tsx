...
import VideoBox from '@/components/footer/modals/webcam/video-box';
import { store, useAppDispatch, useAppSelector } from '@/store';
import VirtualBackground from '@/components/virtual-background/virtual-background';
import BackgroundItems from '@/components/footer/modals/webcam/background-items';
import { updateVirtualBackground } from '@/store/slices/bottom-icons-activity-slice';
